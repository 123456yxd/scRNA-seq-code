...
#	python $dir/make_matrix_mixed_species.py ${custom_name}_v11_threshold_0 # We make matrix from filtered UMIs by other code!!!
...
#	rm -r ${custom_name}_FC # bam files after feature counts (featureCounts_directional_5)#s
